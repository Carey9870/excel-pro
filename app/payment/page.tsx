...
export default async function PaymentPage() {
  ...
  try {
    ...
    throw new Error("Failed to initiate payment: " + (error as Error).message);
  }

  return (
    <div className="container mx-auto p-4 max-w-4xl">
      <h1 className="text-3xl font-bold mb-4">Subscribe to Continue</h1>
      <p>Your trial has ended. Unlock your best content yet — subscribe for just $10/month to effortlessly optimize your writing, blogs, and ads. More clarity. More clicks. More results. Better Ranking.</p>
